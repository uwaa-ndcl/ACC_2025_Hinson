...
qbar = [164 207 240 281];                                                   % set of dynmaic pressures
...
load(['./Data/q' num2str(qbar(bb)) '_4_als_scaled/M_sys_Noise_' num2str(seed)]);
...
Q = ALS.Qest_cell{1};
A = ALS.A_scr;
b = [ALS.Eyy1; ALS.Eyy2; ALS.Eyy3; ALS.Eyy4]; 

if ~isfolder('./Results/Constrained');mkdir('./Results');end
